// This is a special, one-time use script to upload your product data to Firestore.
...
// --- The Complete Product Data ---
// This is the data that will be uploaded.
const products = [
    // --- Women's Products ---
...
/**
 * A function to upload all products to the 'products' collection in Firestore.
 * It uses the product's 'id' as the document ID in Firestore.
 */
