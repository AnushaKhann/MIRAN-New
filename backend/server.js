...
// --- Serve Static Files (CSS, Frontend JS, Images) ---
// This correctly serves all files from the 'frontend' directory.
app.use(express.static(path.join(__dirname, '..', 'frontend')));


// --- THE "DATABASE": A Complete Product Array with STANDARDIZED Image Paths ---
// All folder and file names are now lowercase with hyphens for consistency.
const products = [
    // --- Women's Products ---
